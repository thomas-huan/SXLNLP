...
class SiameseNetwork(nn.Module):
    ...
    def cosine_distance(self, tensor1, tensor2):
        tensor1 = torch.nn.functional.normalize(tensor1, dim=-1) #模长
        tensor2 = torch.nn.functional.normalize(tensor2, dim=-1) #模长
        cosine = torch.sum(torch.mul(tensor1, tensor2), axis=-1) #外积
        return 1 - cosine
